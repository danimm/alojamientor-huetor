...
const messages = {
    es: {
        ...
        home: {
            main: {
                text1:
                    "Ven y vive una experiencia única en las mejores casas rurales de la provincia de Málaga.",
                button1: "Galería",
                button2: "Reservar"
            },
            description: {
        ...
        reservations: {
            ...
            title:
                "Consulta las fechas disponibles para tus próximas vacaciones",
        ...
        contact: {
            text1:
                "Hola! Soy Isa escríbeme cualquier duda que tengas y te intentaré responder en menos de 24 horas.",
    ...
    en: {
        ...
        footer: {
            text1:
                "For reservations, inquiries or additional information contact us.",
        ...
        home: {
            main: {
                text1:
                    "Come and live a unique experience in the best rural houses of Malaga.",
                button1: "Gallery",
            ...
            columns: {
                ...
                text1:
                    "Live an unforgettable experience with us, and enjoy the tranquility, well-being and nature of this wonderful place.",
                text2:
            ...
            cards: {
                ...
                card1: {
                    ...
                    text:
                        "Enjoy from the terrace of our houses one of the best views of the highest peak of Malaga: La Maroma (2,066 m)."
                },
                card2: {
                    title: "The Lake La Viñuela",
                    text:
                        "Gaze at every day the views of the reservoir of Viñuela, a fantastic place to enjoy the outdoors or even water sports."
                },
                card3: {
        ...
        contact: {
            text1:
                "Hello! I am Isa, write me any questions you have and I will try to answer you in less than 24 hours.",
            ...
            privacity:
                "** By submitting this form you agree to our privacy policy. For more information, see conditions ",
            link: "here.",
            button: "Send"
        }
    },
    de: {
        ...
        footer: {
            text1:
                "Für Reservierungen, Anfragen oder ergänzende Informationen, nehmen Sie mit uns Kontakt auf.",
        ...
        home: {
            main: {
                text1:
                    "Komm und erlebe unvergessliche Momente in den besten Landhäusern der Region Málaga.",
                button1: "Galerie",
                button2: "Reservierungen"
            },
            description: {
                title:
                    "Hier findest du Ruhe und Erholung. Überzeuge dich selbst und lass uns dich bei uns willkommen heissen.",
                text1:
        ...
        reservations: {
            card: {
                ...
                list: {
                    ...
                    item11:
                        "Babybett und Hochkinderstuhl (gegen Gebühr) buchbar",
        ...
        contact: {
            text1:
                "Hallo, ich heisse Isa und beantworte deine Fragen, wenn möglich innerhalb 24 Stunden.",
            ...
            privacity:
                "** Mit dem Absenden dieses Formulars stimmen Sie unseren Datenschutzbestimmungen zu. Weitere Informationen finden Sie ",
            link: "hier.",
            button: "Senden"
        }
    },
    fr: {
        ...
        footer: {
            text1:
                "Pour les réservations, demandes de renseignements ou des informations supplémentaires, contactez-nous.",
        ...
        home: {
            main: {
                text1:
                    "Venez vivre une expérience unique dans les meilleures maisons rurales de la province de Malaga.",
                button1: "Galerie",
                button2: "Reservierungen"
            },
            description: {
                title:
                    "Ici vous trouverez calme et repos. Venez nous rencontrer.",
                text1:
            ...
            rooms: {
                ...
                text2:
                    "Cheminée dans le salon pour ceux qui aiment la chaleur du feu en hiver. Climatisation et chauffage (dans les chambres).",
        ...
        reservations: {
            card: {
                ...
                list: {
                    ...
                    item11:
                        "Lit bébé et chaise haute disponibles (prix supplémentaire)",
                    item12: "Bois de chauffage (supplément)"
                }
            },
            title:
                "Vérifiez les dates disponibles pour vos prochaines vacances",
        ...
        contact: {
            text1:
                "Bonjour,  Je suis Isa, écrivez-moi toutes vos questions et je tenterai de vous répondre dans moins de 24 heures.",
