  ...
  de: {
    ...
    home: {
      ...
      description: {
        ...
        text1: 'Alojamientos Huetor bietet dir einen Ort, an dem du einen angenehmen und erholsamen Aufenthalt im Herzen der Region Málaga geniessen kannst.',
        text2: 'Von dort aus können die verschiedenen Städte sowohl im Landesinneren als auch an der Küste bewundert werden. Jede von ihnen bietet ihren Bewohnern und allen Menschen reizvolle Landschaften, Bräuche, Feste sowie typische Produkte.',
      ...
      columns: {
        ...
        text1: 'Geniesse mit uns ein unvergessliches Erlebnis und nutze die Ruhe, das Wohlbefinden und die Natur dieses wunderschönen Ortes.',
        text2: 'Es ist der perfekte Ort, um einen erholsamen und / oder abenteuerlichen Urlaub zu verbringen. Mit einfachem Zugang zu verschiedenen Golfplätzen, Naturparks, Wildtierparks, Wasserparks, die Möglichkeit von Bergwanderungen und alles rund um den Stausee. Die Strände oder einfach nur das Sonnenbaden auf der Terrasse oder am Pool der Unterkunft bietet dir dieser ideale Ort.'
      },
      rooms: {
        title: 'Wie zuhause',
        text1: 'Jedes Haus besteht aus zwei grossen Schlafzimmern, einem Wohn- / Esszimmer, einer voll ausgestatteten Küche, zwei Badezimmern und einer grossen Terrasse mit Grill.',
        text2: 'Cheminée im Wohnzimmer für diejenigen, die im Winter die Wärme des Feuers mögen. Klimaanlage und Heizung (in den Schlafzimmern).',
      ...
      cards: {
        ...
        card1: {
          ...
          text: 'Geniesse von der Terrasse unserer Häuser aus einen der besten Ausblicke auf den höchsten Gipfel der Provinz Mlaga: La Maroma (2.066 m)'
        },
        card2: {
          title: 'Der See La Viñuela',
          text: 'Bewundere jeden Tag die Aussicht auf den Stausee von La Viñuela, ein fantastischer Ort, um die Natur oder den Wassersport zu geniessen.'
        },
        card3: {
          title: 'La costa del Sol',
  ...
  fr: {
    ...
    home: {
      ...
      description: {
        ...
        text1: "Alojamientos Huetor est un lieu pensé pour profiter d’un séjour agréable et relaxant au cœur de l'Axarquía, province de Málaga.",
        text2: "D'où vous pourrez visiter les différentes villes, tant à l'intérieur des terres que sur la côte, où dans chacune d'elles, vous trouverez des paysages charmants, des coutumes, des fêtes, des produits typiques, et leurs charmants habitants.",
      ...
      columns: {
        ...
        text1: 'Vivez une expérience inoubliable avec nous et profitez de la tranquillité, du bien-être et du caractère naturel de ce lieu merveilleux.',
        text2: "C'est l'endroit idéal pour passer des vacances reposantes et / ou intenses. Avec un accès facile aux différents terrains de golf, aux parcs naturels, d'animaux sauvages, et aquatiques, aux randonnées en montagne et autour du réservoir, aux plages ou juste au soleil sur la terrasse ou la piscine de l'hébergement, c'est l'endroit idéal."
      },
      rooms: {
        title: 'Comme à la maison',
        text1: 'Chaque maison se compose de deux grandes chambres à coucher, salon / salle à manger, cuisine entièrement équipée, deux salles de bain, une grande terrasse avec barbecue.',
      ...
      cards: {
        ...
        card1: {
          ...
          text: "Profitez de la terrasse de nos maisons de l'une des plus belles vues sur le plus haut sommet de la province de Malaga: La Maroma (2 066 m)"
        },
        card2: {
          title: 'Le Lac de la viñuela',
          text: 'Contemplez chaque jour la vue sur le réservoir de Viñuela, un endroit fantastique pour profiter du plein air ou même des sports nautiques.'
        },
        card3: {
          title: 'La Sunshine Coast',
          text: 'Avec 320 jours de soleil par an, Malaga est un endroit idéal pour bronzer sur la plage (à 15 minutes) ou dans notre magnifique piscine.'
        }
      },
      offer: {
