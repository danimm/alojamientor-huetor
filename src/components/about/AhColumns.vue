  ...
  .container-fluid
    .container
      .grid-container
        ...
        .img-container-2
          img(src="https://firebasestorage.googleapis.com/v0/b/huetor-16ddf.appspot.com/o/images%2FImage16.jpg?alt=media&token=65341002-e939-4d96-a800-81b40690af01")
        .text-container-2
...
<style scoped>
  ...
  .grid-container {
    ...
    grid-gap: 10px;
    grid-template-areas:  "text1 img1 img2"
                          "text2 text2 img2";
    /* height: 800px; */
    margin-bottom: 50px;
  }
